...
// #include "controller/servers/2134/LootCrateFarmerController.h"
...
namespace Darks {
	...
	public:
		DarksDiscord(
			...
			Darks::Controller::TribeLogController& tribe_log_controller
			// Darks::Controller::Servers::_2134::LootCrateFarmerController& loot_crate_farmer_controller
		);
	...
	private:
		...
		Darks::Controller::TribeLogController& tribe_log_controller_;
		// Darks::Controller::Servers::_2134::LootCrateFarmerController& loot_crate_farmer_controller_;
	};
}
