...
Darks::Controllers::Island::LootCrateFarmerController::LootCrateFarmerController(
	...
	hotkey_manager_(hotkey_manager)
{
	...
	crates_->push_back(new DefaultCrate( // massive
		conf_.massive_bed_,
		conf_.screen_shot_loot_rect_,
		&conf_.massive_enabled_,
		true,
		inventory_controller,
		camera_controller,
		general_controller,
	...
	crates_->push_back(new SwampCaveCrate( // swamp 01
		conf_.swamp_bed_01_,
		conf_.screen_shot_loot_rect_,
		&conf_.swamp_01_enabled_,
		true,
		inventory_controller,
		camera_controller,
		general_controller,
	...
	crates_->push_back(new SwampCaveCrate( // swamp 02
		conf_.swamp_bed_02_,
		conf_.screen_shot_loot_rect_,
		&conf_.swamp_02_enabled_,
		false,
		inventory_controller,
		camera_controller,
		general_controller,
	...
	crates_->push_back(new PackCaveCrate( // pack 02 -- swims farther down
		conf_.pack_bed_02_,
		conf_.screen_shot_loot_rect_,
...
void Darks::Controllers::Island::LootCrateFarmerController::DisplayCtrlPanel() {
...
bool Darks::Controllers::Island::LootCrateFarmerController::StartTimer(
...
bool Darks::Controllers::Island::LootCrateFarmerController::StopTimer(GlobalTimerManager& timer_manager) {	
	if (!timer_id_) {
...
void Darks::Controllers::Island::LootCrateFarmerController::Run(
	SyncInfo& info,
