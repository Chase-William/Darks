...
namespace Darks::Controllers::Servers::_2134 {
	...
	public:
		...
		IO::Rect screen_shot_loot_rect_ = IO::Rect(1605, 315, 2345, 560);

		IO::HotKey cancel_run_once_hotkey_ = IO::HotKey(IO::Key::Num9);
	};

	class LootCrateFarmerController : public IDisplayCtrlPanel, public IQueueable, public ISpecifyServer {
	public:
